...
const JobDiscoveryMockup = () => (
  <div className="space-y-3">
    {[
      ...
      <motion.div
        key={job.company}
        className="bg-slate-50 rounded-xl p-3 flex items-center gap-3 border border-slate-200 hover:border-blue-300 transition-colors"
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span className="text-slate-800 font-medium text-sm truncate">{job.role}</span>
        ...
        <div className={`px-2 py-1 rounded-full text-xs font-semibold ${
          job.match >= 90 ? "bg-emerald-100 text-emerald-700" : "bg-blue-100 text-blue-700"
        }`}>
          {job.match}% match
        </div>
      </motion.div>
    ...
    <div className="flex items-center justify-between pt-2">
      <span className="text-xs text-slate-400">Showing top matches</span>
      <span className="text-xs text-blue-600">View all 47 jobs →</span>
    </div>
  </div>
);
      ...
      <div className="flex items-center gap-3">
        <div className="relative w-12 h-12">
          <svg className="w-12 h-12 -rotate-90">
            <circle cx="24" cy="24" r="20" fill="none" strokeWidth="3" stroke="#e2e8f0" />
            <motion.circle 
          ...
          <span className="absolute inset-0 flex items-center justify-center text-slate-800 font-bold text-sm">82</span>
        </div>
        <div>
          <div className="text-slate-800 font-medium text-sm">Resume Score</div>
...
const ApplicationTrackingMockup = () => (
  <div className="space-y-4">
    ...
    <div className="flex items-center gap-1">
      {[
        ...
        >
          ...
          <div className="text-slate-800 font-bold text-lg">{stage.count}</div>
          <div className="text-slate-500 text-[10px]">{stage.stage}</div>
        </motion.div>
      ))}
    </div>
    ...
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
      <div className="text-xs text-slate-400 mb-2">Recent Updates</div>
      {[
        ...
        >
          ...
          <div className="flex-1">
            <span className="text-slate-800 text-xs">{item.company}</span>
  ...
  <div className="space-y-3">
    ...
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-slate-600 text-xs font-medium">Current Case</span>
      </div>
      <div className="text-slate-800 font-medium text-sm mb-1">Market Entry Strategy</div>
      <div className="text-slate-500 text-xs mb-3">McKinsey Practice • Intermediate</div>
      <div className="flex items-center gap-2">
        ...
        <span className="text-slate-500 text-xs">65%</span>
      </div>
    </div>
  ...
  <div className="space-y-3">
    {[
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="text-slate-800 font-medium text-sm truncate">{event.title}</div>
          <div className="text-slate-500 text-xs">{event.date} • {event.type}</div>
        </div>
        <button className={`px-2 py-1 rounded-full text-[10px] font-medium ${
          event.rsvp ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-600 hover:bg-blue-100 hover:text-blue-700"
        }`}>
  ...
  <div className="space-y-3">
    ...
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
      <div className="flex items-center justify-between mb-3">
        <span className="text-slate-600 text-xs font-medium">Weekly Activity</span>
      ...
      <div className="flex justify-between mt-1">
        <span className="text-slate-400 text-[9px]">Mon</span>
        <span className="text-slate-400 text-[9px]">Sun</span>
      </div>
    </div>
    ...
    <div className="grid grid-cols-3 gap-2">
      {[
        ...
        <motion.div
          ...
          transition={{ delay: 0.4 + i * 0.1 }}
        >
          <div className="text-slate-800 font-bold text-lg">{stat.value}</div>
  ...
  <div className="space-y-3">
    ...
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
      <div className="flex items-center justify-between mb-2">
        <span className="text-slate-600 text-xs font-medium">Weekly Engagement</span>
        <div className="flex items-center gap-1">
    ...
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
      <div className="flex items-center gap-2">
        ...
        <span className="text-slate-700 text-xs">Peak activity: <span className="text-blue-600 font-medium">Tuesdays 2-4pm</span></span>
      </div>
    </div>
  </div>
);
...
const ApplicationsInsightsMockup = () => (
  <div className="space-y-3">
    {/* Funnel Visual */}
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
      <div className="text-slate-600 text-xs font-medium mb-3">Application Pipeline</div>
      {[
        ...
        >
          <div className="w-12 text-right">
            <span className="text-slate-700 text-xs font-medium">{stage.count}</span>
          </div>
          <div className="flex-1">
            <motion.div
          ...
          <span className="text-slate-500 text-[10px] w-16">{stage.stage}</span>
        </motion.div>
      ))}
    </div>
    ...
    {/* Top Roles */}
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
      <div className="text-slate-400 text-[10px] mb-2">Top Roles Applied</div>
...
const QualificationInsightsMockup = () => (
  <div className="space-y-3">
    ...
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
      <div className="flex items-center justify-between mb-3">
        <span className="text-slate-600 text-xs font-medium">Materials Quality</span>
        <span className="text-slate-400 text-xs">926 students</span>
      </div>
      <div className="flex gap-0.5 h-5 rounded-full overflow-hidden">
        {[
          ...
          >
            <span className="text-white text-[9px] font-medium">{seg.label}</span>
          </motion.div>
        ))}
      </div>
    </div>
    ...
    {/* Skills Gap */}
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
      <div className="text-slate-400 text-[10px] mb-2 flex items-center gap-1">
      ...
      {[
        ...
        <motion.div
          ...
          transition={{ delay: 0.3 + i * 0.1 }}
        >
          <span className="text-slate-600 text-xs">{item.skill}</span>
  ...
  <div className="space-y-3">
    ...
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-3 border border-blue-200">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-slate-600 text-xs font-medium">Market Trend</span>
      </div>
      <p className="text-slate-800 text-sm">Tech hiring up <span className="text-emerald-600 font-bold">23%</span> in Q1 vs last year</p>
    </div>

    {/* Top Hiring Companies */}
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
      <div className="text-slate-400 text-[10px] mb-2">Top Hiring This Month</div>
      {[
        ...
        <motion.div
          ...
          transition={{ delay: 0.2 + i * 0.1 }}
        >
          <span className="text-slate-700 text-xs">{item.company}</span>
          <div className="flex items-center gap-2">
            <span className="text-slate-500 text-xs">{item.openings} roles</span>
    ...
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
      <div className="flex items-center justify-between">
        <span className="text-slate-600 text-xs">Placement Rate</span>
        <span className="text-emerald-600 font-bold text-lg">78.5%</span>
      </div>
    </div>
  </div>
);
